...
object _03_TreeMap {
  def main(args: Array[String]): Unit = {
    ...
    // Initialize a Map
    val map01: TreeMap[Int, String] = TreeMap(2 -> "Two", 1 -> "One")
    println(map01)

    // Initialize a map with tuple elements
    val map02: TreeMap[Int, String] = TreeMap((2, "two"), (1, "one"), (3, "three"))
    println(map02)

    val emptyMap: TreeMap[String, String] = TreeMap.empty[String, String]
